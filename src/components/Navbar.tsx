  ...
  return (
    <>
      <style>{`
        ...
        .stg-user-pill:hover { border-color: rgba(255,255,255,0.25); background: rgba(255,255,255,0.08); }
        .stg-user-avatar {
        ...
        .stg-user-name { font-size: 13px; color: var(--text); }
        ...
        .stg-mob-search-overlay {
          ...
          padding: 14px clamp(16px,4%,48px) 18px;
        ...
        .stg-mob-search-combined {
          ...
          display: flex; align-items: center;
          background: var(--bg-card);
          border: 1.5px solid rgba(13,199,94,0.35);
          border-radius: 14px;
        ...
        .stg-mob-search-overlay .stg-trend-pop {
          position: absolute; left: 0; right: 54px; top: calc(100% + 8px);
        }
        .stg-mob-search-overlay .stg-loc-pop {
        ...
        <div className="stg-mob-search-overlay">
          <div className="stg-mob-search-row" ref={mobSearchRef}>
            <div className="stg-mob-search-combined">
              <div className="stg-mob-search-icon">
