...
export default function UserDashboardLayout({ children, invitationCount = 0 }: UserDashboardLayoutProps) {
  ...
  const secondaryNav: NavItem[] = [
    { label: 'Become a Sub Admin', icon: <User size={17} />,       to: '/dashboard/sub-admin' },
  ...
  const bottomTabs: NavItem[] = [
    ...
    { label: 'Tickets',  icon: <Ticket size={20} />,          to: '/dashboard/tickets' },
    { label: 'Events',   icon: <CalendarDays size={20} />,    to: '/events' },
    { label: 'Settings', icon: <Settings size={20} />,        to: '/dashboard/settings' },
  ]
    ...
    <>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .udl-drawer.open { transform: translateX(0); }
        ...
        .udl-drawer-profile { display: flex; align-items: center; gap: 12px; }

        .udl-drawer-name {
          font-size: 15px; font-weight: 700; color: #fff; font-family: Inter, sans-serif;
        }
        .udl-drawer-email {
          font-size: 12px; color: rgba(255,255,255,0.4); font-family: Inter, sans-serif; margin-top: 1px;
        }
        ...
        .udl-tab {
          ...
          padding: 8px 16px; border-radius: 12px; border: none; background: none;
          cursor: pointer; transition: background 0.15s; min-width: 60px;
          -webkit-tap-highlight-color: transparent; touch-action: manipulation;
        }
        .udl-tab-label { font-size: 10px; font-weight: 500; font-family: Inter, sans-serif; }
        ...
        .udl-tab.active { background: rgba(34,197,94,0.08); }
      ...
      <div className="udl-shell">
        ...
        <aside className="udl-sidebar">
          ...
          <img
            ...
            alt="Grow your event"
            style={{ width: '100%', borderRadius: 12, marginBottom: 12, cursor: 'pointer', marginTop: 16 }}
        ...
        <div className={`udl-drawer ${drawerOpen ? 'open' : ''}`}>
          ...
          <nav className="udl-drawer-nav">
            ...
            {/* Banner in mobile drawer too */}
            <img
              src="/sidebar-banner.png"
              alt="Grow your event"
              style={{ width: '100%', borderRadius: 12, marginTop: 16, cursor: 'pointer' }}
              onClick={() => { navigate('/manage'); setDrawerOpen(false) }}
            />
          </nav>
